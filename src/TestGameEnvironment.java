...
public class TestGameEnvironment {
    public static void main(String[] args) {
        GUI gui = new GUI("Game Environment Test", GameEnvironment.WIDTH,  GameEnvironment.HEIGHT);
        ...
        int widthSpace = 50;
        int heightSpace = 25;
        for (int i = blockWidth; i < gameEnvironment.HEIGHT / 2; i += blockHeight + heightSpace) {
            Color blockColor = new Color(Geometry.RAND.nextInt(255), Geometry.RAND.nextInt(255), Geometry.RAND.nextInt(255));
            for (int j = blockWidth; j + blockWidth + widthSpace < gameEnvironment.WIDTH; j += blockWidth + widthSpace) {
